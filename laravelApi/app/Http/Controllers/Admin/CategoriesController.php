...
class CategoriesController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('categories.index')->with('success', 'Обновление категории прошло успешно!!!');
    }
    ...
    public function destroy($id)
    {
        ...
        $category->delete();
        return redirect()->route('categories.index')->with('success', 'Категория удаена!!!');
    }
}
